...
class SolutionCustomerControllerTest {
  ...
  void return_not_found_if_customer_for_addRental_cannot_be_found() {
    ...
    assertThat(controller.addRental("", new AddRental("", 1))).isEqualTo(notFound().build());
  }
  ...
  void return_not_found_if_customer_for_getInvoice_cannot_be_found() {
    ...
    assertThat(controller.getInvoice("")).isEqualTo(notFound().build());
  }
  ...
  void return_not_found_if_customer_for_getJsonInvoice_cannot_be_found() {
    ...
    assertThat(controller.getJsonInvoice("")).isEqualTo(notFound().build());
  }
  ...
  void return_json_invoice() {
    ...
    assertThat(controller.getJsonInvoice(CUSTOMER_NAME_1))
        .isEqualTo(
            ok(
